translations = {
    'en': {
        'start_message': "Welcome! In this survey, we will ask you a few questions about your feelings and experiences. Your answers will be kept confidential and will not be shared with anyone. You can stop the survey at any time by typing /stop. If you need help, you can type /help. Let's get started!",
        ...
        'starting_main_survey': "In this survey you need to answer with voice messages. Please press the microphone button and answer the question. Please, try to tell us as much as you can. If you don't want to answer, you can type /skip.",

        'voice_out_of_survey': 'You are currently not in a survey. Please start the main survey to answer questions.',
    },
    'de': {
        'start_message': "Willkommen! In dieser Umfrage werden wir Ihnen einige Fragen zu Ihren Gefühlen und Erfahrungen stellen. Ihre Antworten werden vertraulich behandelt und nicht weitergegeben. Sie können die Umfrage jederzeit beenden, indem Sie /stop eingeben. Wenn Sie Hilfe benötigen, können Sie /help eingeben. Lass uns anfangen!",
        ...
        'starting_main_survey': 'In dieser Umfrage müssen Sie mit Sprachnachrichten antworten. Bitte drücken Sie die Mikrofontaste und beantworten Sie die Frage. Bitte versuchen Sie, uns so viel wie möglich zu erzählen. Wenn Sie nicht antworten möchten, können Sie /skip eingeben.',
    ...
    'ru': {
        'start_message': "Добро пожаловать! В этом опросе мы зададим вам несколько вопросов о ваших чувствах и опыте. Ваши ответы будут храниться конфиденциально и не будут переданы кому-либо. Вы можете остановить опрос в любое время, набрав /stop. Если вам нужна помощь, вы можете набрать /help. Давайте начнем!",
        ...
        'starting_main_survey': 'В этом опросе вам нужно отвечать голосовыми сообщениями. Пожалуйста, нажмите кнопку микрофона и ответьте на вопрос. Пожалуйста, попробуйте рассказать нам как можно больше. Если вы не хотите отвечать, вы можете набрать /skip.',
